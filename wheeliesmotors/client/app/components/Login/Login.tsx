  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if(logUser.data.role ==="client") {   
        push("/components/home")
      }
      if(logUser.data.role ==="admin") {
        push("/components/admin")
      }
      ErrNotif()
    } catch (e) {     
    ...
    <div className='flex justify-center items-center h-screen '>
      ...
      <div className="container" >
        ...
        <div className="card mx-auto">
          ...
          <h1  className='-mt-6 mb-4  '>Already have account  ?  </h1> <Link className='-mt-6 ' href={'/components/Signup'}><span className='underline  cursor-pointer'>  Register Now</span></Link>
          </div>
