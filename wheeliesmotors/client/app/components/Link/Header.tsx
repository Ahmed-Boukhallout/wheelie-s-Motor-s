...
import { FaPhone, FaEnvelope, FaFacebook, FaLinkedin, FaInstagram, FaTwitter } from "react-icons/fa";
import "./style.css";
...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("https://image1.jdomni.in/banner/23012023/9A/5A/16/7B937CF737C8934D26F518BC15_1674472715541.jpg")' }}>
        <div className={`absolute inset-x-0 top-0 flex items-center justify-between p-2 `} style={{background: "transparent"}}>
          <div className="flex items-center">
            <div className="flex mr-4 ">
              <FaFacebook className="text-l mr-2" style={{ color: "black" }} />
              <FaLinkedin className="text-l mr-2" style={{ color: "black" }} />
              <FaInstagram className="text-l mr-2" style={{ color: "black" }} />
            ...
            <div className="flex">
              ...
              <FaEnvelope className="text-l mr-2" style={{ color: "black" }}  />
      ...
      {/* Original Navbar */}
      <div className={`fixed w-full z-10 p-2 transition-top duration-300 ease-in-out ${header ? 'bg-white text-black top-0' : 'bg-transparent text-white -top-15px mt-6'}`}>
        <nav className="flex items-center justify-between flex-wrap">
          ...
          <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto ml-24">
            <div className="text-sm lg:flex-grow ml-8">
              <Link href="/" className={`block mt-4 lg:inline-block lg:mt-0 ${header ? 'text-gray-600' : 'text-black'} hover:text-gray-600 hover:border-b-2 hover:border-gray-600 mr-4`}>Home</Link>
              ...
              <Link href="/about-us" className={`block mt-4 lg:inline-block lg:mt-0 ${header ? 'text-gray-600' : 'text-black'} hover:text-gray-600 hover:border-b-2 hover:border-gray-600 mr-4`}>About Us</Link>
      ...
      <img src="https://image1.jdomni.in/banner/23012023/9A/5A/16/7B937CF737C8934D26F518BC15_1674472715541.jpg" alt="img" />
