...
import AllPro from '../../products/AllProducts';
...
<div className="absolute w-[500px] h-[600px] top-[200px] left-[342px] bg-secondary rounded-[4px] overflow-hidden">
     <img className="absolute w-[446px] h-[546px]  left-[27px]"  src={hoveredImage || product.ProductImage&&product.ProductImage[1]} alt='Image0'  />
    </div>
    ...
    <div className="absolute top-[200px] left-[910px] font-heading-24px-semibold font-[number:var(--heading-24px-semibold-font-weight)] text-text-2 text-[length:var(--heading-24px-semibold-font-size)] tracking-[var(--heading-24px-semibold-letter-spacing)] leading-[var(--heading-24px-semibold-line-height)] whitespace-nowrap [font-style:var(--heading-24px-semibold-font-style)]">
