...
const productList = [
  ...
  { id: 9, name: 'APACHE RTR 160', image: "https://image3.jdomni.in/banner/23012023/D1/FB/5F/96801179D51A06B6D059C21EC6_1674473106063.jpeg?output-format=webp", price: '₹1,06,622' }
];
...
const ProductSlider = () => {
  ...
  <div className="flex p-4 relative bg-white overflow-x-auto" ref={containerRef} style={{ scrollSnapType: 'x mandatory', display: 'flex',overflowX:'hidden', width: '100%', height: '22rem' }}>
